...
namespace GoogleDeepMind.GemmaSampleGame
{
    ...
    public class PlayerInteractable : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEvent<InteractableObject> OnInteract;

        /** Sphere collider that defines the interaction detection area */
        private SphereCollider detectionAreaCollider;
        ...
        private void Awake()
        {
            detectionAreaCollider = GetComponent<SphereCollider>();
        }
        ...
        private void Start()
        {
            detectionAreaCollider.radius = interactionRadius;
            detectionAreaCollider.isTrigger = true;
        }
